      ...
      <main className="main text-white bg-black md:pb-10">
        ...
        >
          <motion.div
            ...
            className="h-screen flex gap-10 items-center justify-center rounded-md w-full pb-[10vh]"
          >
            ...
            <section className="absolute z-40 top-[30%] left-[18%]">
              <div className="bg-[#006837b7] w-60 h-auto rounded-xl mt-16 ml-20 p-5">
                ...
                <button className="border-2 rounded-lg p-1 mt-6 px-3 text-nowrap ml-10">
                  OBLIVION BATTERY
                </button>
                <h3 className="text-end leading-tighter tracking-tighter font-thin mt-2">
          ...
          <footer className="flex w-full h-[40vh] px-6 items-center justify-between">
            <div className="flex items-center gap-4 rounded-xl bg-[#c4c3c339] py-2 px-4">
              ...
              <button className="bg-[#006837e2] py-2 px-5 font-thin rounded-xl">
                APPLY NOW
              </button>
            </div>
          </footer>
