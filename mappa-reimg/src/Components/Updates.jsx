...
// const Popup = ({ updatesData, onClose }) => (
...
//       <tag className='border-2 py-1 px-5 border-[#006837] rounded-full sm:text-lg'><span className='text-md'>{updatesData.tag}</span></tag>
//       <h2 className='text-md inline-block'>{updatesData.date}</h2>
//     </div>
//       <h2 className="text-xl mt-4">{updatesData.title}</h2>
//       <p className='text-md mt-4'> {updatesData.details}</p>
//     </div>
//   </div>
// );
